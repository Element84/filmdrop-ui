...
import { _clearSelectedFootprints } from '../../utils/mapHelper.js'
// import {
//   envSceneTilerURL,
...
const Search = () => {
  ...
  function onClearSelectedClick() {
    _clearSelectedFootprints()
  }

  return (
    <div className="Search" data-testid="Search">
      <button onClick={onClearSelectedClick}>clearSelected</button>
    </div>
  )
}
