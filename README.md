...
| SUPPORTS_AGGREGATIONS    | If included and set to `true`. Aggregations features are disabled and API calls are not made to load the optional aggregations from the STAC API.                                                                                                                                                                                                                                                                                                                                                                             | Optional |
